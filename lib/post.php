...
class Writing_On_GitHub_Post {
    ...
    public function github_path() {
        ...
        write_log(sprintf(__('github directory: %s, github_filename: %s'), $this->github_directory(), $this->github_filename()));
    ...
    public function github_directory() {
        ...
        switch ( $this->type() ) {
            ...
            case 'lesson':
				...
				{
                    write_log(sprintf(__('Module for lesson %s could not be grabbed!'), $this->get_name()));
				}
